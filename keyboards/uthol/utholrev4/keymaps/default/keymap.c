...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ortho_5x12(
        ...
        KC_LCTL,   SETTINGS,   KC_LGUI,   KC_LALT,  RAISE,  KC_SPC, KC_MPLY,LOWER,  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
    ),
    ...
    [_COLEMAK] = LAYOUT_ortho_5x12(
        ...
        KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
        KC_LCTL,   SETTINGS, KC_LGUI, KC_LALT, RAISE,   KC_SPC, KC_TRNS, LOWER,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),

    [_LOWER] = LAYOUT_ortho_5x12(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_MINS, KC_EQL,  KC_INS,
        KC_TRNS, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC, KC_BSLS,
        KC_P0,   KC_P4,   KC_P5,   KC_P6,   KC_PPLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MSTP, KC_TRNS,
        KC_TRNS, KC_P1,   KC_P2,   KC_P3,   KC_PEQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP, KC_END,
    ...
    [_RAISE] = LAYOUT_ortho_5x12(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGDN, KC_PGDN, KC_TRNS
    ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_SETTINGS] = { ENCODER_CCW_CW(KC_VOLU,     KC_VOLD) },
};
